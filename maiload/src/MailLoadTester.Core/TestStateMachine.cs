...
/// <summary>High-level lifecycle of one SMTP load test.</summary>
public enum TestPhase
{
    Idle = 0,
    Validating = 1,
    PreparingAttachments = 2,
    ConnectingSmtp = 3,
    Sending = 4,
    BatchPause = 5,
    Completed = 6,
...
/// <summary>Fine-grained state of one message/worker operation.</summary>
...
/// <summary>
/// Single source of truth for high-level test transitions.
/// UI code should render the state, not decide it.
/// </summary>
public sealed class TestStateMachine
{
    ...
    public static bool IsAllowed(TestPhase from, TestPhase to)
    {
        ...
        return (from, to) switch
        {
            ...
            (TestPhase.PreparingAttachments, TestPhase.Sending) => true, // dry-run
